...
def find_rhymes(text: str) -> dict:
    ...
    for word_a, word_b in combinations(words_ipa_deduplicated, 2):
        ...
        normalized_score = score / (normalizer_word_length ** 0.7) # Ignoring word length would be score / normalizer_word_length, but longer matching words are better
        results.append({
            "word_a": word_a,
            "word_b": word_b,
            "distance": score,
...
text = "Nie chcę spadać w otchłań, biegnę z górki. Mam się czołgać, jest stroma, nie chcę wrócić."
